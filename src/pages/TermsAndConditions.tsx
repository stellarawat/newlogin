...
export const TermsAndConditions: FC = () => {
    return (
        <>
                <span>
                    <h1 style={{fontFamily:'sans-serif', fontSize: '18px',textDecoration: 'underline', marginTop:'30px'}}>Terms And Conditions</h1>
                    <p>
                    ...
                    <p> 1. Eligibility </p>
                    <span>
                        To participate in the Tushinde lottery, players must:
                        <ul>
                            <li>Be at least 18 years of age.</li>
                            <li>Have a valid phone number registered in Kenya.</li>
                            <li>Agree to these terms and conditions and the official rules of the lottery.</li>
                            <li>Not be employees or family members of employees of Tushinde or its affiliates.</li>
                        </ul>
                    </span>

                    <p> 2. Registration </p>
                    <span>
                        Players must register using a valid mobile phone number to participate in the lottery. By registering, players agree to provide accurate information and consent to receive lottery-related communication.
                    </span>

                    <p> 3. Lottery Participation </p>

                        <ul>
                            <li>Participation is through SMS, online, or via the Tushinde app.</li>
                            <li>Each ticket purchased entitles the player to one entry in the lottery draw.</li>
                            <li>All entries must be received before the official lottery draw deadline.</li>
                            <li>Lottery results will be posted on the Tushinde website and communicated through registered mobile numbers.</li>
                        </ul>

                    <p> 4. Prizes </p>
                        <ul>
                            <li>Winners will be determined based on a random draw of eligible entries.</li>
                            <li>Prizes must be claimed within 90 days from the date of the draw.</li>
                            <li>Unclaimed prizes after 90 days will be forfeited and returned to Tushinde for future draws.</li>
                            <li>Prizes will be paid through mobile money or bank transfer.</li>
                        </ul>
